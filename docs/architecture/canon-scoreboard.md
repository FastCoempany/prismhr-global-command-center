...
|---|---|---|---|---|---|---|---|
| P1 | The wayfinder archives /today (app-wayfinder.tsx:86-100) while refresh() revalidates it (actions.ts:68) and it runs full derivation (today/page.tsx:65 … | Chute (283) | Whether /today is a surface or an archive, and whether a filing still owes it a refresh. | encoded | GOVERN: archived means out of every tab and revalidation list | CLAUDE.md:590 | batch 4 · 2026-09-25; 710fab5 |
| P2 | The Intranet's Send-it box writes intranetDoc rows and never files an AccountNote [pass-1 cite, intranet/actions.ts:103-245] | Chute (276, 281) | Whether Send-it is an intake, and if so that it files through roomPaste. | encoded | GOVERN: a capture naming an account files through the paste pipeline | CLAUDE.md:301 | batch 4 · 2026-09-25; 710fab5 |
| P3 | A note carries no record of which door filed it: createAccountNoteRow (write.ts:26-58) takes no door field and `source` names the dialect | Ted doctrine (359-375) | Whether the record must say which door filed a note. | encoded | GOVERN: every note records its door in its own column | CLAUDE.md:405 | batch 4 · 2026-09-25; 710fab5 |
| P4 | Second-record rows are written bare with kind "mine", source "activity" and no lane, actors or recipients (run.ts:190-191, :208-209) | Second record (404-419); Ted doctrine | Whether namespaced store rows may wear a record kind, or must carry one no first-record reader recognizes. | encoded | GOVERN: second-record rows carry full provenance | CLAUDE.md:405 | batch 4 · 2026-09-25; 710fab5 |
| D1 | The Intranet mounts a second Chute with an inline roster that lacks people and aka (intranet/page.tsx:118-138); a chain test pins the mount (vault.tes … | "ONE intake at the top" (276) | Whether the Intranet carries a Chute at all, and if so that it must take routingRoster(). | encoded | GOVERN: one Chute, one roster, wherever it mounts (R11 A) | CLAUDE.md:301 | batch 4 · 2026-09-25; 710fab5 |
| D2 | A .csv that probes as the activity report leaves roomPaste for the second record (chute.tsx:356-359; upload.ts:14-24); the ActivityDock is a second do … | Second record (404-419); Chute (281) | Which doors take the export, and what the Drop does with one. | encoded | GOVERN: Chute or dock take the export; the Drop refuses .csv (R12 A) | CLAUDE.md:301 | batch 4 · 2026-09-25; 710fab5 |
| D3 | PDFs and images go to the model before any routing (chute.tsx:360; actions.ts:1732-1791): 8 MB cap, claude-opus-5, a 60,000 slice, and a prompt that a … | "read on the spot" (277); the VTT clause (277-279) | What a PDF or image transcript is and whether it earns the CALL TRANSCRIPT path. | encoded | GOVERN: the transcriber emits CALL TRANSCRIPT for a call (R4 A) | CLAUDE.md:301 | batch 4 · 2026-09-25; 710fab5 |
| D4 | Caps with no receipt: 60,000 / 400,000 with a truncation note (actions.ts:187-192); docx 60,000 (read-file.ts:93); sheets 4 tabs / 400 rows / 30,000 ( … | (277) | What may be cut on the way in and whether every cut appears on the receipt. | encoded | GOVERN: file and text kept whole; only the model read is windowed, on the receipt | CLAUDE.md:301 | batch 4 · 2026-09-25; 710fab5 |
| D5 | The picker and the batch-mate button file with force: true (chute.tsx:578, :600), skipping both guard rungs but never the duplicate guard; the batch-m … | "waits for the operator's pick" (284); routing (279-281) | Whether a pick is final and unguarded, and whether batch siblings are a routing signal. | encoded | GOVERN: the pick is final; a batch sibling is a suggestion | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D6 | Unreadable files route by filename and vault with no guard and no pick when a name matches (chute.tsx:361-368) | "Nothing files blind" (284) | Whether vaulting counts as filing. | encoded | GOVERN: vaulting is filing, with a receipt and a take-back | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D7 | The duplicate guard and its marker both fail open (actions.ts:231-233, :133-136); a ✕-parked filing keeps its marker (:1486-1491) | (287-289) | Guard or gate; and whether a parked filing is "on file". | encoded | GOVERN: the duplicate check fails open and says so; parked is on file (R15 A) | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D8 | The GitHub vault: browser-carried raw bytes under accounts/<Account>/<file>, a 25 MB / 2 GB split, a token handed to the browser (archive-actions.ts:1 … | none | Canonize the vault: naming, lanes, the browser-held token, and the money boundary. | encoded | GOVERN: the vault is canon, server-side upload, evidence outside the money boundary (R16 B) | CLAUDE.md:307 | batch 7 · 2026-09-25; 710fab5 |
| D9 | Two verdicts per filing: a keyless early rung with an empty claim (actions.ts:241-261) and a late rung on the read's claim (:318-339); keyless session … | (283-284) | Whether a filing may be disputed twice. | encoded | GOVERN: one verdict per filing, one pick answers both rungs | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D10 | Owner "them" actions are dropped from the fan-out (actions.ts:520); read.signals is never stored (ai-clean.ts:22); fan-out dedupes against open todos, … | (281-283) | Where their commitments and the read's signals live; whether a repeated commitment is one; confirm the marker-not-close rule. | encoded | GOVERN: their commitments are loops on their side; marker, never close | CLAUDE.md:305 | batch 6 · 2026-09-25; 710fab5 |
| D11 | Unbounded parallel swallows: N concurrent model reads and N grant calls before grantRef fills (chute.tsx:388-391, :255-264) | (277) | A concurrency ceiling. | encoded | GOVERN: at most three reads at once; the rest wait in drop order | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D12 | Per-receipt ✕ and "Clear the receipts" (chute.tsx:409-434, :733-743), decreed 2026-09-01 in a comment and pinned in chain (second-record-faces.test.ts … | (285-286) | Canonize receipt dismissal, the receipt fold's budget, and what the ledger may keep. | encoded | GOVERN: receipts dismiss per row and all; settled rows keep no address or text | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D13 | routingRoster() with contact emails, domains and people is serialized as a client prop (room/page.tsx:793, :842) while roster.ts:2-3 says contacts.jso … | none | Whether the book's contact emails may ship in the RSC payload. | encoded | GOVERN: routing runs on the server; the roster never ships | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D14 | Typed rich notes route through roomPaste and its guard and dedupe (room-client.tsx:394-403) | (281) | Whether a typed note is a paste. | encoded | GOVERN: a typed note is a paste | CLAUDE.md:303 | batch 5 · 2026-09-25; 710fab5 |
| D15 | refresh() names five paths (actions.ts:65-71) and every page is force-dynamic, so the list decides nothing today | "every tab re-derives" (283) | Whether refresh() is the canonical tab list or dead code. | encoded | GOVERN: no revalidation list; refresh() retires | CLAUDE.md:305 | batch 6 · 2026-09-25; 710fab5 |
| D16 | The fingerprint hashes the head line including the filename (paste-files.ts:42-53, :196, :309, :478), so a renamed file or an .eml/.msg twin of one ma … | "the same capture" (288) | What "the same capture" means. | encoded | GOVERN: the same capture is the same body, head skipped (R2 B) | CLAUDE.md:305 | batch 6 · 2026-09-25; 710fab5 |
| D17 | Second-record slices overwrite per account at run.ts:298 before the manifest verifies at :306-342; a refused or abandoned upload leaves new slices und … | "an incomplete upload refuses to run" (413-414) | Whether staging must verify before any slice replaces its predecessor. | encoded | GOVERN: staging verifies before any slice replaces its predecessor | CLAUDE.md:489 | batch 6 · 2026-09-25; 710fab5 |
| D18 | The take-back deletes all four second-record spans (run.ts:1131-1137), including the operator's hand actedDay stamps (act-actions.ts:127-142); srdraft … | "every stamp carries ↺" (457); "the record's own entries are never unwritten" (330) | Whether the operator's acted stamps are the first record or die with the second. | encoded | GOVERN: the acted stamp is the first record and survives the take-back | CLAUDE.md:489 | batch 6 · 2026-09-25; 710fab5 |
| D19 | The colleague roster is "assigned on two or more accounts" (ingest.ts:100-105, :359-362); lastOrgInbound is the export's account-level Last Email Rece … | (409-410); Ted 373-374; closer rule | Whether an account person seen on two accounts is a colleague, and whether an account-level datetime counts as "their voice". | encoded | GOVERN: colleague by the book or our domain; a bare datetime is never their voice | CLAUDE.md:489 | batch 6 · 2026-09-25; 710fab5 |
| D20 | The acted match is `text.includes(w)` over the who and head of the 60 newest notes (run.ts:1033-1052); "Natalie B." never matches gem who "Natalie Bor … | (417-418); (412-413) | What counts as the record moving on a gem's person; whether campaign titles are "the blast". | encoded | GOVERN: acted by address or normalized name; tallies and titles may upload | CLAUDE.md:489 | batch 6 · 2026-09-25; 710fab5 |
| D21 | Gem act, reason, what and signal are model prose rendered verbatim (day.ts:343-344; evidence-chips.tsx:219-220); the canon lint checks mood, length, h … | (418-419); writing canon; plain-speech law | Whether the seven devices are linted on gem lines, and whether digits in gem prose are "rendered counts". | encoded | GOVERN: gem lines are operator copy; devices linted, non-date digits die | CLAUDE.md:489 | batch 6 · 2026-09-25; 710fab5 |
| D22 | The vehicle fallback `?? list[0]` / `?? bearers[0]` (day.ts:537, :604) lets a 70-weight slot outrank an account's own 52 move when no free account exi … | Vehicle rule (446-449) | Whether a vehicle may ever collide or must drop for the day. | encoded | GOVERN: a vehicle never collides; it drops for the day | CLAUDE.md:278 | batch 7 · 2026-09-25; 710fab5 |
| D23 | The Act Lane's ✉ head carries no dialect token (act-actions.ts:108), so provenance.ts:200-211 cannot infer its actors from the body; CT and SN heads a … | "Send files a real ✉ outbound" (463-464); the note grammar | Whether every writer must emit a head the legacy inferrer accepts, or every reader must keep the actors column. | encoded | GOVERN: the column is the record; every writer fills it (R3 A) | CLAUDE.md:405 | batch 7 · 2026-09-25; 710fab5 |
| D24 | The pad's ASK THE APP register routes (padAsk, scratch/actions.ts:164-200) under a pact that says nothing routes; onBlur keeps an edit (scratchpad.tsx … | Scratchpaper (298-299, 303-304) | Whether the ask door is part of the paper, and whether click-away keeps. | encoded | GOVERN: the ask door is not the paper; click-away keeps | CLAUDE.md:329 | batch 7 · 2026-09-25; 710fab5 |
| D25 | The engine computes a court line the client never renders (engine.ts:242-272; room/page.tsx:605; room-client.tsx:120), pinned by a chain test (intrada … | Spring (343) | Whether the retired court line is dead code to delete or an engine fact the move lines must carry. | encoded | GOVERN: the court line retires in full; the test pins the move line | CLAUDE.md:367 | batch 7 · 2026-09-25; 710fab5 |
| D26 | The Klaxon opens the send window at 7:00 (instrument.tsx:18-24) while the band table says 9:00 to 11:00 (day.ts:168-178) and the chain pins 10a/12:30p … | Groundwork face (254-257) | One clock for the band. | encoded | GOVERN: one band table; sends open at 9:00 Chicago | CLAUDE.md:278 | batch 7 · 2026-09-25; 710fab5 |
| D27 | Sheet stamps for seated, second-record-gem and engaged-never-introduced carry no subtext (groundwork/page.tsx:420-471 default "") | "The wing never stamps mutely" (331-332) | The label each of those three rules speaks. | encoded | GOVERN: no rule stamps with an empty label | CLAUDE.md:278 | batch 7 · 2026-09-25; 710fab5 |
| D28 | Hand-typed dated actions never read PROMISED (sheet-view.ts:176), only paste-provenance rows | Closer rule (389-390) | Whether a date the operator heard and typed is a promise. | encoded | GOVERN: PROMISED needs a hearer | CLAUDE.md:425 | batch 7 · 2026-09-25; 710fab5 |
| D29 | The Chute renders nothing without canWrite (chute.tsx:627); read-only sessions have no intake and no receipt ledger | (276) | What a read-only session sees at the top of the HomeRoom. | encoded | GOVERN: a read-only session sees the bar and receipts; the bar says why | CLAUDE.md:309 | batch 8 · 2026-09-25; 710fab5 |
| D30 | scratch rows and every other namespaced row consume the intranet mirror's 400-row budget before being skipped (runners.ts:146-151) [inferred] | Scratchpaper (297-298); Chute (283) | Whether namespaced rows are excluded in the query rather than after it. | encoded | GOVERN: the mirror excludes namespaced rows in the query | CLAUDE.md:309 | batch 8 · 2026-09-25; 710fab5 |
...
| C9 | Groundwork, 266-268 | Vehicle rule, 446-449 | The vehicle rule with a fallback: day.ts:536-537 `bearers.find(p => !t … | aligned | vehicle rule stands; the bearer has no candidate of its own | CLAUDE.md:278 · day.ts · canon/groundwork | batch 2 · 2026-09-25; 710fab5; pass 5 |
| C10 | Scratchpaper, 301-302 | Other standing decrees, 538-539 | The Scratchpaper: scratch/actions.ts:70, :296 no redact; :171 redacts … | aligned | Scratchpaper 301-302 stands; the pad keeps figures | CLAUDE.md:584 · write.ts keepFigures · canon/ted-doctrine | batch 3 · 2026-09-25; 710fab5; pass 5 |
| C11 | Playbook face, 519-525 | Other standing decrees, 538-539 | The face: countries.ts:165-179 and country/route.ts:28-30 never call r … | aligned | Playbook 519-525 stands; statutory facts render as authored | CLAUDE.md:584 · countries.ts · playbook-sheet | batch 3 · 2026-09-25; 710fab5; pass 5 |
| C12 | Playbook authoring canon, 124-126 | Playbook face, 516-518 | The face: playbook-client.tsx:153, :176-177; playbook/page.tsx:158, :1 … | aligned | Playbook face 516-518 stands; the register's names are cites | CLAUDE.md:572 · playbook-client.tsx | batch 3 · 2026-09-25; 710fab5; pass 5 |
| C13 | Click-depth, 397-399 | Playbook face, 514-516 | The carve-out: src/lib/ask/links.ts:65-70; tests/ask-links.test.ts:28 … | encoded | both stand; the citation opens in place to the bank's question | CLAUDE.md:572 | batch 3 · 2026-09-25; 710fab5; pass 5 |
| C14 | Spring, 345-347 | Spring, 344 | Both: controls carry only `title=` (room-client.tsx:1270, :1279, :1365 … | aligned | 344 stands; nothing superseded, the legend is the one place | CLAUDE.md:370 · room-client.tsx | batch 2 · 2026-09-25; 710fab5; pass 5 |
| C15 | Second record faces, 425 | Act Lane, 474-476 | The Act Lane: accounts-client.tsx:1199-1210 | aligned | Act Lane 474-476 stands; the hover glyph clause is retired text | CLAUDE.md:487 · accounts-client.tsx:1199 | batch 2 · 2026-09-25; 710fab5; pass 5 |
| C16 | Second record faces, 427-428 | Design canon, 11-16 and 37 | The face: room.module.css:2330 `#8a5a00` | encoded | design canon stands; THEIRS is the account's people, in blue | CLAUDE.md:485 | batch 2 · 2026-09-25; 710fab5; pass 5 |
| C17 | Writing canon 4, 55-56 | Plain-speech law, 79-81 | The carve-out [answer-row copy not re-read this pass] | aligned | plain-speech 79-81 stands; answer rows hedge | CLAUDE.md:80 · answer rows | batch 3 · 2026-09-25; 710fab5; pass 5 |
| C18 | Sendbook, 317-318 | Ted, 363 | The Sendbook's "the book": groundwork/page.tsx:828-831 passes contacts … | encoded | Ted 363 stands; the chip row offers the record's people too | CLAUDE.md:356 | batch 1 · 2026-09-25; 710fab5; pass 5 |
| C19 | Direct doctrine, 240-241 | Act Lane, 477-479 | The gate: campaigns/index.ts:22-25; accounts-client.tsx:425-429 | encoded | direct doctrine stands; the Approach is a fact, never a gate | CLAUDE.md:247 | batch 2 · 2026-09-25; 710fab5; pass 5 |
| C20 | Chute, 283-284 | Chute, 285-287 | Interrupted: chute.tsx:84, :96-97 | aligned | 283-284 stands; a waiting pick survives a reload (R14 A) | CLAUDE.md:299 · chute-ledger.ts · canon/chute | batch 2 · 2026-09-25; 710fab5; pass 5 |
