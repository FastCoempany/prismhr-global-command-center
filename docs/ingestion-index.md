...
- [docs/architecture/brand-identity.md](architecture/brand-identity.md): GEM visual identity, including the donor-kit boundary, Signal Plot app mark, color-role doctrine, typography, iconography, lexicon, and brand QA.
...
- [config/design-tokens.css](../config/design-tokens.css): runtime visual tokens importing donor kit colors/motion and mapping app aliases to GEM roles.
...
| Brand Identity | [docs/architecture/brand-identity.md](architecture/brand-identity.md) | `relationship-motion`, `hml`, `decision-log`, `plan-before-code` | GEM visual identity with donor-kit visual doctrine, explicit exclusion of donor name/mark/wordmark, Signal Plot mark, role colors, typography, iconography, lexicon, and brand QA. |
...
| GEM Iconography | [docs/architecture/field-glyphs.md](architecture/field-glyphs.md) | `relationship-motion`, `hml`, `decision-log`, `plan-before-code` | App-owned SVG iconography system borrowing donor construction grammar while excluding donor identity assets. |
