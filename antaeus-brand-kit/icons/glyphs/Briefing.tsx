/**
 * Briefing — "Briefing" glyph. GENERATED — do not hand-edit; the
...
export function BriefingGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <path d="M3 12s3.4-7 9-7 9 7 9 7-3.4 7-9 7-9-7-9-7z"/><circle cx="12" cy="12" r="2.6"/>
        </svg>
    );
}
