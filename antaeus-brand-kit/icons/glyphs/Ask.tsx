/**
 * Ask — "ask" glyph. GENERATED — do not hand-edit; the
...
export function AskGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <circle cx="10" cy="9" r="3"/><path d="M5 20a5 5 0 0 1 10 0"/><path d="M16 6a2.4 2.4 0 0 1 2 4l-1 1"/>
        </svg>
    );
}
