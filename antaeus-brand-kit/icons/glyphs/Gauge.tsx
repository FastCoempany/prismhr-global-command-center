/**
 * Gauge — "the gauge" glyph. GENERATED — do not hand-edit; the
...
export function GaugeGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <rect x="11" y="4" width="9" height="16"/><path stroke-width="3" d="M7 4v16"/>
        </svg>
    );
}
