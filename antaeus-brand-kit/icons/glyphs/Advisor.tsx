/**
 * Advisor — "Advisor" glyph. GENERATED — do not hand-edit; the
...
export function AdvisorGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <circle cx="11" cy="8" r="3"/><path d="M5 19a6 6 0 0 1 12 0"/><path d="M18 6a3 3 0 0 1 0 5"/>
        </svg>
    );
}
