/**
 * Handoff — "Handoff" glyph. GENERATED — do not hand-edit; the
...
export function HandoffGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <path d="M3 9h11"/><path d="M10 5l5 4-5 4"/><path d="M21 15H10"/><path d="M14 11l-5 4 5 4"/>
        </svg>
    );
}
