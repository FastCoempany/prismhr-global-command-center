/**
 * Attention — "attention" glyph. GENERATED — do not hand-edit; the
...
export function AttentionGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <path d="M12 4v10" stroke="var(--ds-icon-accent, currentColor)"/><path d="M12 17v2" stroke="var(--ds-icon-accent, currentColor)"/>
        </svg>
    );
}
