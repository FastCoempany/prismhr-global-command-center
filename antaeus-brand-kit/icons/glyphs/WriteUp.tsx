/**
 * WriteUp — "write up" glyph. GENERATED — do not hand-edit; the
...
export function WriteUpGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <rect x="5" y="4" width="14" height="17"/><path d="M9 4V3h6v1"/><path d="M9 12l1.6 1.6L14 10"/>
        </svg>
    );
}
