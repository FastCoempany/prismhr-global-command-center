/**
 * Observation — "observation" glyph. GENERATED — do not hand-edit; the
...
export function ObservationGlyph({ size }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            width={size}
        ...
        >
            <circle cx="6" cy="9" r="1.5"/><path d="M10 9h10"/><circle cx="6" cy="15" r="1.5"/><path d="M10 15h7"/>
        </svg>
    );
}
