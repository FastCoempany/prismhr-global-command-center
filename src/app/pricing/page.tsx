...
const contractRows = [
  ...
  { service: "International Payroll", peo: ["Custom"], onboarding: ["Custom"], smb: ["Custom"], revshare: ["Custom"] },
  { service: "Contractor Services", peo: ["$27"], onboarding: ["N/A"], smb: ["$45"], revshare: ["$18"] },
  { service: "Contractor Plus Services", peo: ["$135"], onboarding: ["N/A"], smb: ["$225"], revshare: ["$90"] },
];
  ...
  return (
    <>
      ...
      <main className={styles.wrap}>
        ...
        <p className={styles.sub}>
          What&apos;s being built to contract in Salesforce / CPQ — leverage this on in-process
          opportunities. Every country carries a designated tier (1–3). If a PEO doesn&apos;t know
          its countries yet, quote the tier range — e.g. <b>$500–$650 PEPM</b> for SMB-direct EOR.
          All prices are PEPM (per employee, per month) unless marked one-time. ETA for contracts /
          SF CPQ setup: <b>July 10 at the earliest</b>; a 2nd training will walk through contracting.
        </p>
        ...
        <div className={styles.narGrid}>
          <div className={styles.narCard}>
            ...
            <p>
              Use the <b>List Price (SMB pricing)</b>. The PEO earns the <b>revenue share</b> (the
              Recommended Markup column). This is what the system is set up to accommodate today —
              favor it.
            </p>
          </div>
          <div className={styles.narCard}>
            ...
            <p>
              Use the <b>PEO pricing</b>. The PEO then has the option to bill their SMB themselves,
              at the Recommended List Price or a price of their choice. Some elements are still being
              worked out — harder to execute for now.
            </p>
          </div>
        </div>
        <div className={styles.banner}>
          <strong>Ask each PEO:</strong> is the requirement a one-month deposit? Confirm before you
          quote.
        </div>
